...
public class MManusia {
    public static void main(String[] args) {
        ...
        Petani pt1 = new Petani("Nugraha", LocalDate.of(1977,01,07),"Jl. Bunga 9 Tembalang",5000000,"wonogiri");
        PNS p2 = new PNS("Panji",LocalDate.of(2010,04,01),null,10000000,"198004212010041002");
